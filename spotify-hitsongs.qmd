...
We can interpret that very few release months have a higher number of hit songs than an average number of hit songs (which is almost between 0-10) in a month. We observe that the highest spike in the number of hit songs happens in March 2023 (more than 600 hit songs) followed by February 2023 and January 2023. This has a very interesting pattern and shows us that more number of songs in the recent months have started becoming successful when compared to the last decade.
